...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * This method to handle ResponseStatusException that provide message error, http status and cause
	 * @param ex
	 * @param request
	 * @return
	 */
	...
	protected ResponseEntity<Object> handleFileDuplicate(FileDuplicateException ex, WebRequest request){
		ApiError apiError = new ApiError(CONFLICT);
		System.out.println();
		apiError.setMessage(ex.getFileName());
		return buildResponseEntity(apiError);
	}
